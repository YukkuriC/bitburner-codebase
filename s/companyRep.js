...
const companys = ['ECorp', 'MegaCorp', 'Bachman & Associates', 'Blade Industries', 'NWO', 'Clarke Incorporated', 'OmniTek Incorporated', 'Four Sigma', 'KuaiGong International', 'Fulcrum Technologies']
const works = ['software', 'software consultant', 'it', 'security engineer', 'network engineer', 'business', 'business consultant', 'security', 'agent', 'employee', 'part-time employee', 'waiter', 'part-time waiter']
const repLim = 1e30
